...
public class EmployeeRepositoryCustomImpl implements EmployeeRepositoryCustom {
    ...
    public long getMaxEmpId() {
        ...
        query.limit(1);
        ProductCollection maxObject = mongoTemplate.findOne(query, ProductCollection.class);
        if (maxObject == null) {
            return 0L;
        }
    ...
    public long updateEmployee(String empNo, String fullName, Date hireDate) {
        ...
        UpdateResult result = this.mongoTemplate.updateFirst(query, update, ProductCollection.class);
